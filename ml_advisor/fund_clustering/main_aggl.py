...
# cluster
model = AgglomerativeClustering(n_clusters=n_clusters, affinity='euclidean', memory=None, 
                                connectivity=None, compute_full_tree='auto', 
                                linkage='ward').fit(scaled_data)
...
pd.Series(portfolio, name = 'Stocks').to_hdf("../../evaluation/portfolios_ml/fundamental/ml_fundamental_portfolio_agg_1.hdf5", "dataset1/x")
...
pd.Series(portfolio, name = 'Stocks').to_hdf("../../evaluation/portfolios_ml/fundamental/ml_fundamental_portfolio_agg_2.hdf5", "dataset1/x")
...
pd.Series(portfolio, name = 'Stocks').to_hdf("../../evaluation/portfolios_ml/fundamental/ml_fundamental_portfolio_agg_3.hdf5", "dataset1/x")
